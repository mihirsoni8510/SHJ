...
export default function AdminSidebar({ isOpen, setIsOpen }: SidebarProps) {
    ...
    return (
        <>
            ...
            <aside
                className={`bg-white border-r border-gray-200 h-screen sticky top-0 overflow-y-auto transition-all duration-300 ease-in-out z-40 ${isOpen ? 'w-64 translate-x-0' : 'w-20 -translate-x-full md:translate-x-0'
                    } fixed md:sticky left-0 shadow-xl md:shadow-none`}
            >
